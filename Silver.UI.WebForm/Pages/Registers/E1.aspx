<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="E1.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.E1" %>
    ...
    <fieldset>
        ...
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="IdServidor" HeaderText="Servidor">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="Placa" HeaderText="Placa" DataFormatString="{0:000}">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="Posicao" HeaderText="Posição" DataFormatString="{0:000}">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
        ...
        <asp:Panel runat="server" ID="Panel_Cadastrar" Visible="true" CssClass="modalPopup">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:RadioButtonList ID="lstServidor" runat="server" CellPadding="0" CellSpacing="0"
                                Height="80px" RepeatColumns="5" RepeatDirection="Horizontal" Width="100%">
                            </asp:RadioButtonList>
                        </div>
                        <asp:RequiredFieldValidator ID="rvServidor" runat="server" ControlToValidate="lstServidor"
                            ErrorMessage="* Favor selecionar o Servidor" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbPlaca" MaxLength="150"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rvPlaca" runat="server" ControlToValidate="tbPlaca"
                            ErrorMessage="* Favor preencher a Placa" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbPosicao" MaxLength="150"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rvPosicao" runat="server" ControlToValidate="tbPosicao"
                            ErrorMessage="* Favor preencher a Posição" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbContrato" MaxLength="150"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rvContrato" runat="server" ControlToValidate="tbContrato"
                            ErrorMessage="* Favor preencher o Contrato" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
