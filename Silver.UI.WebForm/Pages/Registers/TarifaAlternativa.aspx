<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="TarifaAlternativa.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.TarifaAlternativa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        <legend>Tarifas Alternativas Cadastradas:</legend>
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="IdTarifaTipo" HeaderText="Tipo Tarifa">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:BoundField DataField="IdTarifaRegra" HeaderText="Regra">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
        ...
        <asp:Panel runat="server" ID="Panel_Cadastrar" Visible="true" CssClass="modalPopup">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbDescricao" MaxLength="255" CssClass="TextBox"></asp:TextBox>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:RadioButtonList ID="lstTarifaTipo" runat="server" CellPadding="0" CellSpacing="0"
                                Height="60px" RepeatColumns="5" RepeatDirection="Horizontal" Width="100%">
                            </asp:RadioButtonList>
                        </div>
                        <asp:RequiredFieldValidator ID="rvTarifaTipo" runat="server" ControlToValidate="lstTarifaTipo"
                            ErrorMessage="* Favor selecionar o Tipo" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:RadioButtonList ID="lstTarifaRegra" runat="server" CellPadding="0" CellSpacing="0"
                                Height="60px" RepeatColumns="5" RepeatDirection="Horizontal" Width="100%">
                            </asp:RadioButtonList>
                        </div>
                        <asp:RequiredFieldValidator ID="rvTarifaRegra" runat="server" ControlToValidate="lstTarifaRegra"
                            ErrorMessage="* Favor selecionar a Regra" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rvOperadora" runat="server" ControlToValidate="lstOperadora"
                            ErrorMessage="* Favor selecionar a Operadora" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:RadioButtonList ID="lstCampanha" runat="server" CellPadding="0" CellSpacing="0"
                                Height="60px" RepeatColumns="5" RepeatDirection="Horizontal" Width="100%">
                            </asp:RadioButtonList>
                        </div>
                        <asp:RequiredFieldValidator ID="rvCampanha" runat="server" ControlToValidate="lstCampanha"
                            ErrorMessage="* Favor selecionar a Campanha" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbValor" MaxLength="10" CssClass="TextBox"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rvValor" runat="server" ControlToValidate="tbValor"
                            ErrorMessage="* Favor preencher o Valor" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
