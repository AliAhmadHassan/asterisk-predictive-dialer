<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="TarifaRegra.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.TarifaRegra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <td valign="middle">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:ImageButton ID="btNovo" runat="server" ImageUrl="~/Imagens/New.png" 
                                    OnClick="btNovo_Click" OnClientClick="LimparFormulario(this.form)"
                                    title="Iniciar um novo cadastro" Enabled="False" />
    ...
    <fieldset>
        ...
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            <Columns>
                <asp:ButtonField ButtonType="Image" Visible="false" CommandName="Alterar" Text="Atualizar" HeaderText=""
                ...
                <asp:ButtonField ButtonType="Image" CommandName="Excluir" Text="Excluir" HeaderText=""
                    ImageUrl="~/Imagens/Ico/grid_deletar.png" Visible="False">
                    <ControlStyle Width="16px" />
                    <ItemStyle Width="16px" />
                </asp:ButtonField>
