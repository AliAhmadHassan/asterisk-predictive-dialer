<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="TarifaTipo.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.TarifaTipo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:Panel runat="server" ID="Panel_Cadastrar" Visible="false" CssClass="modalPopup">
