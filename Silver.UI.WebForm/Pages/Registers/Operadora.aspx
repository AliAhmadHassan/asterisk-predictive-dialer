<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="Operadora.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.Operadora" %>
        ...
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            <Columns>
                <asp:ButtonField ButtonType="Image" CommandName="Alterar" Text="Atualizar" HeaderText=""
                    ImageUrl="~/Imagens/Ico/grid_atualizar.png" Visible="False">
                ...
                <asp:BoundField DataField="ConsumoMinino" DataFormatString="{0:C}" HeaderText="Valor">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
        ...
        <asp:Panel runat="server" ID="Panel_Cadastrar" Visible="true" CssClass="modalPopup">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbConsumoMinino" MaxLength="10" CssClass="TextBox"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rvConsumoMinino" runat="server" ControlToValidate="tbConsumoMinino"
                            ErrorMessage="* Favor preencher o Consumo Mínino" ForeColor="#CC3300" Font-Bold="False"
                            Font-Italic="True" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
