<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="Tarifacao.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.Tarifacao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:ImageButton ID="btBuscar" runat="server" CssClass="ButtonBuscar" ImageUrl="~/Imagens/search-icon.png"
                                    title="Iniciar a busca" ValidationGroup="form_buscar" />
                            </td>
                            <td>
    ...
    <div>
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            EmptyDataText="Registros não encontrados" ShowFooter="false">
            <Columns>
                ...
                <asp:BoundField DataField="IdBilhetagem" HeaderText="Bilhetagem" />
                <asp:BoundField DataField="IdTarifa" HeaderText="Tarifa" />
                <asp:BoundField DataField="Valor" HeaderText="Valor" />
                <asp:BoundField DataField="IdTarifaAlternativa" HeaderText="Tarifa Alternativa" />
                <asp:BoundField DataField="ValorAlternativo" HeaderText="Valor Alternativo" />
        ...
        <asp:Panel runat="server" ID="Panel_Cadastrar" Visible="true" CssClass="modalPopup">
            ...
            <table style="width: 725px">
                <tr>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:CheckBoxList ID="lstBilhetagem" runat="server" CellPadding="0" CellSpacing="0"
                ...
                <tr>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:CheckBoxList ID="lstTarifa" runat="server" CellPadding="0" CellSpacing="0" Height="80px"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbValor" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="CheckBoxList">
                            <asp:CheckBoxList ID="lstTarifaAlternativa" runat="server" CellPadding="0" CellSpacing="0"
                                Height="80px" RepeatColumns="5" RepeatDirection="Horizontal" Width="100%">
                            </asp:CheckBoxList>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="tbValorAlternativo" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td style="height: 5px;">
                        ...
                        <asp:Button ID="btCadastrar_Sim" runat="server" CssClass="ButtonSalvar" 
                            OnClick="btCadastrar_Sim_Click" Text="" Width="79px" />
                        &nbsp;<asp:Button ID="btCadastrar_Nao" runat="server" CssClass="ButtonCancelar" 
                            OnClick="btCadastrar_Nao_Click" Text="" ValidationGroup="Cancelar" 
                            Width="79px" />
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="vertical-align: top; height: 5px; text-align: center">
                        <asp:Button ID="btExcluir_Sim" runat="server" OnClick="btExcluir_Sim_Click" Text="Sim"
                            Width="79px" ValidationGroup="Excluir" />
