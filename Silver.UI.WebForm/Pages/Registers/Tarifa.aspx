<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="Tarifa.aspx.cs" Inherits="Silver.UI.Web.Presentation.Pages.Registers.Tarifa" %>
    ...
    <fieldset>
            ...
            <ContentTemplate>
                <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                    <ProgressTemplate>
                        ...
                        <span style="color: #777777; font-size: 10px;">Processando solicitação. . .</span>
                    </ProgressTemplate>
                </asp:UpdateProgress>
            </ContentTemplate>
        </asp:UpdatePanel>
        <asp:GridView ID="GridViewObjeto" runat="server" OnRowCommand="GridViewObjeto_RowCommand"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Valor" DataFormatString="{0:C5}" HeaderText="Valor">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
